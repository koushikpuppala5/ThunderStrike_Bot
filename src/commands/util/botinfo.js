...
**${lang.BOT.DJS_V}:** ${version}`,
      ...
      .addField(
        "Links",
        `
[${lang.BOT.CONTRIBUTORS}](https://github.com/koushikpuppala5/ThunderStrike_Bot/contributors)
[${lang.BOT.INVITE_BOT}](https://discord.com/oauth2/authorize?client_id=${bot.user.id}&scope=bot&permissions=1945632119)`,
        true
      )
      .addField(
        `${lang.BOT.REPO}`,
